...
/*
  This is the HEADED mode smoke test for visual debugging.
  It runs the same checks as the headless smoke test but launches a 
  full browser window so developers can observe the test execution.
*/
